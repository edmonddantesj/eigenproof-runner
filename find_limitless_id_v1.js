...
async function findOwnerIdV1() {
    try {
        ...
        const endpoints = ["/users/me", "/auth/session", "/profile/me"];
        
        for (const ep of endpoints) {
            console.log(`🔍 Checking ${API_BASE_URL}${ep} with cookie...`);
            ...
            if (res.statusCode === 200) {
                console.log("💎 FOUND!! DATA:", res.body);
            }
        }
    } catch (e) {
