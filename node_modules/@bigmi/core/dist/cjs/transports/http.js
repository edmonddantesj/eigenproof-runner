...
const createBatchScheduler_js_1 = require("../utils/createBatchScheduler.js");
const getHttpRpcClient_js_1 = require("./getHttpRpcClient.js");
const types_js_1 = require("./types.js");
function http(url, config = {}) {
    const { batch, fetchOptions, key = 'http', methods = { exclude: types_js_1.UTXOAPISchemaMethods }, name = 'HTTP JSON-RPC', onFetchRequest, onFetchResponse, retryDelay, raw, } = config;
    return ({ chain, retryCount: retryCount_, timeout: timeout_ }) => {
        ...
        const rpcClient = (0, getHttpRpcClient_js_1.getHttpRpcClient)(url_, {
            fetchOptions,
