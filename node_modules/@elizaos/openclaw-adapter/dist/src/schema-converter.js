...
export function convertSchema(schema) {
    ...
    switch (schema.type) {
        ...
        case "array":
            return Type.Array(schema.items ? convertSchema(schema.items) : Type.Unknown(), desc ? { description: desc } : {});
        case "object":
...
export function convertActionParameters(params) {
    const props = {};
...
export const KNOWN_ACTION_SCHEMAS = {
...
export function fallbackActionSchema(description) {
    return Type.Object({
