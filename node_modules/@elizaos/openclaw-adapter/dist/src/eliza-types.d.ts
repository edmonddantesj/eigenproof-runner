...
export type Handler = (runtime: IAgentRuntime, message: Memory, state?: State, options?: Record<string, unknown>, callback?: HandlerCallback, responses?: Memory[]) => Promise<ActionResult | undefined>;
...
export interface IAgentRuntime {
    ...
    isActionAllowed(actionName: string, context?: Record<string, unknown>): {
        allowed: boolean;
        reason: string;
    };
...
export type OpenClawPluginApi = {
    ...
    registerCli: (registrar: unknown, opts?: {
        commands?: string[];
    }) => void;
    ...
    on: (hookName: PluginHookName, handler: (...args: never[]) => unknown, opts?: {
        priority?: number;
    }) => void;
};
//# sourceMappingURL=eliza-types.d.ts.map