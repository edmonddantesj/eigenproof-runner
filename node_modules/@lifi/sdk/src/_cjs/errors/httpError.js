...
const statusCodeToErrorClassificationMap = new Map([
    [
        400,
        { type: constants_js_1.ErrorName.ValidationError, code: constants_js_1.LiFiErrorCode.ValidationError },
    ],
    [404, { type: constants_js_1.ErrorName.NotFoundError, code: constants_js_1.LiFiErrorCode.NotFound }],
    [
        409,
        {
            type: constants_js_1.ErrorName.SlippageError,
            code: constants_js_1.LiFiErrorCode.SlippageError,
            message: constants_js_1.ErrorMessage.SlippageError,
        },
    ],
    [424, { type: constants_js_1.ErrorName.ServerError, code: constants_js_1.LiFiErrorCode.ThirdPartyError }],
    [429, { type: constants_js_1.ErrorName.ServerError, code: constants_js_1.LiFiErrorCode.RateLimitExceeded }],
    [500, { type: constants_js_1.ErrorName.ServerError, code: constants_js_1.LiFiErrorCode.InternalError }],
]);
const getErrorClassificationFromStatusCode = (code) => statusCodeToErrorClassificationMap.get(code) ?? {
    type: constants_js_1.ErrorName.ServerError,
...
class HTTPError extends baseError_js_1.BaseError {
    ...
    constructor(response, url, options) {
        ...
        super(constants_js_1.ErrorName.HTTPError, errorClassification.code, message);
